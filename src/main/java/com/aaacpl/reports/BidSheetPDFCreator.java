...
public class BidSheetPDFCreator {
    public Paragraph createPDF(Map<Integer, String> userIdNameMap, LiveBidLogDTO liveBidLogDTO,
                               LotDTO lotDTO, int counter, Boolean isAuctionForward) throws DocumentException {
        ...
        if (counter == 1) {
            String bidAmountLabel = isAuctionForward ? "Highest Bid Amount" : "Lowest Bid Amount";
            ...
            insertCell(table, bidAmountLabel, Element.ALIGN_CENTER, 1, bfBold12);
